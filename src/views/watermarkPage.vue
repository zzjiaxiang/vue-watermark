...
<template>
  ...
  <div class="content">
    ...
    <div class="right">
      ...
      <div>Rotate</div>
      <el-slider v-model="rotate" :min="-180" :max="180" />
      <div>FontSize</div>
      <el-slider v-model="font.fontSize" />
      <div>Content</div>
      <el-input v-model="content" />
      <div>Gap</div>
      <el-input-number v-model="gapX" controls-position="right" />
  ...
  <div class="content">
    <water-mark
      image="https://png.zjiaxiang.cn/blog/webps.svg"
      :content="content"
    >
      <pre style="white-space: pre-wrap">
          {{ text }}
